...
(function (global, factory) {
    ...
    function NUMBER([arg], opts) {
        ...
        if (arg instanceof FluentNumber) {
            ...
            return new FluentNumber(value, Object.assign(Object.assign({}, arg.opts), values(opts)));
        }
    ...
    function DATETIME([arg], opts) {
        ...
        if (arg instanceof FluentDateTime) {
            ...
            return new FluentDateTime(value, Object.assign(Object.assign({}, arg.opts), values(opts)));
        }
    ...
    function resolveComplexPattern(scope, ptn) {
        ...
        for (const elem of ptn) {
            ...
            if (part.length > MAX_PLACEABLE_LENGTH) {
                ...
                throw new RangeError("Too many characters in placeable " +
    ...
    class Scope {
        constructor(bundle, errors, args, insideTermReference = false, dirty = new WeakSet()) {
            this.bundle = bundle;
            this.errors = errors;
            this.args = args;
        ...
        _parse(source) {
            ...
            function parsePlaceable() {
                ...
                if (consumeToken(TOKEN_ARROW)) {
                    ...
                    return Object.assign({ type: "select", selector }, variants);
                }
